...
const UserCard = ({ intials, username, bio }: UserCardProps) => {
  return (
    <Link 
      to={`/profile/${username}`}
      className="block bg-white border border-gray-200 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 p-6 w-full max-w-sm mx-auto"
    >
      {/* Header with Avatar */}
